...
impl RecordTrait for DnsRecordRRSIG {
...
impl From<DnsRecordRRSIG> for DnsRecord {
    fn from(record: DnsRecordRRSIG) -> Self {
        DnsRecord::RRSIG(record)
    }
}